    ...
    <div className="min-h-screen bg-[#f3f4f6] py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Adorable and comfortable clothing for your little ones, designed with care and style.
        </p>
      </div>
...
export const metadata = {
  title: "Kids Collection - Dine Market",
  description: "Browse our collection of kids clothing and accessories",
};
